...
func TestAsBlockSchemaWithOptions(t *testing.T) {
	data := "" +
		"as-block:        AS1 - AS4294967295\n" +
		"descr:           Whole as block\n" +
		"org:             ORG-TT1-TEST\n" +
	...
	_, err = NewAsBlockWithOptions(*object, true, []string{})
	if err != nil {
		t.Fatal(err)
	}

	_, err = NewAsBlockWithOptions(*object, true, []string{"does-not-exist"})
	if err != nil {
		t.Fatal(err)
	}
}
